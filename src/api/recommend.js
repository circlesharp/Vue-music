...
export function getRecommend () {
  ...
  const url = debug ? '/api/getTopBanner' : 'http://rtfm.work/music/api/getTopBanner'
...
export function getDiscList () {
  // 线上环境地址，同学们根据自己的需要配置修改
  const url = debug ? '/api/getDiscList' : 'http://rtfm.work/music/api/getDiscList'
...
export function getSongList (disstid) {
  const url = debug ? '/api/getCdInfo' : 'http://rtfm.work/music/api/getCdInfo'
